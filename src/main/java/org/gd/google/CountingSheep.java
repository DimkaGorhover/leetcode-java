...
// @formatter:off
/**
 * FIXME: https://code.google.com/codejam/contest/6254486/dashboard
 *
 * Problem
 *
 * This problem is not part of the 2018 World Finals. You will not earn points in the 2018 World Finals for submitting
 * for this problem.
 *
 ...
 * 3N = 5076. Now she has seen all ten digits, and falls asleep. What is the last number that she will name before
...
class CountingSheep {
    ...
    static class IntSet {
        ...
        boolean isNotEmpty() { return count > 0; }
