 ...
 * @see org.gd.leetcode.p0538.SolutionTest
 * @since 2020-08-04
 */
@SuppressWarnings({"deprecation", "JavadocReference"})
@DisplayName("LeetCode #1038: Binary Search Tree to Greater Sum Tree")
...
class SolutionTest {
    ...
    void test_ConvertBST(TreeNode root, TreeNode expected) {
        assertEquals(expected.copy(), new Solution().bstToGst(root.copy()));
    }
}